  ...
  const questions = [
    {
      ...
      options: [
        ...
        { id: "unclear_q1", label: "Not sure — would need to check with the city attorney", icon: "❓" }
      ]
    },
    {
      id: "q2",
      ...
      options: [
        ...
        { id: "unsure_q2", label: "Not sure — would need to check with the city attorney", icon: "❓" }
      ]
    },
    {
      id: "q3",
